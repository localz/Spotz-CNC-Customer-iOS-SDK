 ...
 * Implement spotzCNCSDKNotificationWhenEnteringStore:order: delegate instead for more control over the notification's content (e.g. title, userInfo, etc).
 * If you implemented spotzCNCSDKNotificationWhenEnteringStore:order:, this delegate implementation will be ignored.
 * @param store The store object that customer entered
 * @param order The related order object that was triggered by this event
 * @return Return custom message to be presented in the push notification. Notification will be not be shown if nil.
 */
 ...
 * @param store The store object that customer entered
 * @param order The related order object that was triggered by this event
 * @return Return SpotzCNCNotification containing the notiifcation data to be presented in the push notification. Notification will be not be shown if nil.
 */
- (SpotzCNCNotification * _Nullable)spotzCNCSDKNotificationWhenEnteringStore:(SpotzCNCLocationStore * _Nonnull)store order:(SpotzCNCOrder * _Nonnull)order;
...
/**
 * Enable notification actions (e.g. Pickup now/Pickup later options - customisable via spotzCNCSDKNotificationActionTitleForIndex: ) along side the notification message generated by spotzCNCSDKNotificationWhenEnteringStore:order: / spotzCNCSDKNotificationMessageWhenEnteringStore:order:
 * Set to false if you do not want to show any action buttons with the notification message.
 *
 * @param order Order object that this actions will be presented for. Use the order information to determine whether to show/hide the actions.
 * @return Return true to show the action buttons, false to hide.
 */
